      ...
      <div className="relative z-20 w-full max-w-[1440px] mx-auto mt-20">
        ...
        >
          <div className="text-white text-4xl font-light" aria-hidden="true">
             <span className="inline-block scale-y-125 scale-x-90 -mt-2 opacity-70 select-none">山</span>
          </div>
          <span className="text-white text-[0.75rem] md:text-[0.85rem] tracking-[0.1em] font-semibold opacity-80 uppercase max-w-[200px] md:max-w-none leading-relaxed">
            Journey to new frontiers. <br className="md:hidden" /> Journey to Noto Nature Park
          </span>
        </motion.div>
        ...
        <div className="overflow-hidden mb-8 md:mb-10">
          <motion.h1
            ...
            className="text-white text-[15vw] sm:text-[18vw] md:text-[22vw] lg:text-[24vw] xl:text-[26vw] font-serif leading-[0.7] tracking-ultra font-medium drop-shadow-2xl"
          >
            VISIT
          </motion.h1>
        </div>
        ...
        <div className="max-w-xs md:max-w-md lg:max-w-lg">
          ...
          >
            <span className="flex items-center px-10 py-5 text-[0.85rem] font-bold tracking-widest uppercase">
              Book an experience
            </span>
