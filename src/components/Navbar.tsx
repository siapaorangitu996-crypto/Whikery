...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="text-[1.5rem] md:text-[1.8rem] font-semibold text-white tracking-tight">
        Notosan
      </div>

      {/* Desktop Menu */}
      <div className="hidden lg:flex items-center space-x-10 xl:space-x-14 text-[0.85rem] font-medium text-white/90">
      ...
      <div className="flex items-center gap-4">
        <Link
          href="#"
          className="hidden sm:block border border-white/40 px-6 md:px-10 py-[0.5rem] md:py-[0.7rem] rounded-sm text-[0.8rem] md:text-[0.85rem] font-medium text-white hover:bg-white hover:text-black transition-all duration-300"
        >
          Register
        </Link>
