...
const Navbar = () => {
  ...
  return (
    <motion.nav
      ...
      className="absolute top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-10 md:px-12 lg:px-24 md:py-12"
    >
      <div className="text-[1.4rem] md:text-[1.6rem] font-semibold text-white tracking-tight">
        Notosan
      </div>

      {/* Desktop Menu */}
      <div className="hidden lg:flex items-center space-x-12 xl:space-x-16 text-[0.9rem] font-medium text-white/90">
        <Link href="#" className="hover:text-white transition-colors duration-300">Community</Link>
      ...
      <div className="flex items-center gap-4">
        <Link
          href="#"
          className="hidden sm:block border border-white/40 px-10 md:px-14 py-[0.6rem] md:py-[0.8rem] rounded-[2px] text-[0.9rem] font-medium text-white hover:bg-white hover:text-black transition-all duration-300"
        >
          Register
        </Link>
